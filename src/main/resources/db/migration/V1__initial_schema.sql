-- ============================================================
-- V1: Initial schema for Trading Bot (IBKR Edition)
-- ============================================================
...
CREATE TABLE trade_orders (
    ...
    ibkr_parent_order_id        INT,
    ibkr_take_profit_order_id   INT,
    ibkr_stop_loss_order_id     INT,
    ibkr_perm_id                BIGINT,
...
CREATE INDEX idx_orders_parent       ON trade_orders(ibkr_parent_order_id);
CREATE INDEX idx_orders_perm         ON trade_orders(ibkr_perm_id);
