...
/**
 * Empty default implementation of TWS API's EWrapper.
 *
 * EWrapper has 100+ callback methods. We only care about a handful, so this
 * class provides no-op defaults. Subclasses (IbkrEventWrapper) override what
 * they actually need.
 *
 * NOTE: TWS API's EWrapper is an interface in the official jar. The exact
 * signatures depend on the TWS API version - if you upgrade the jar, some
 * method signatures may change. Run `mvn compile` after upgrading to catch
 * any new abstract methods.
 */
public abstract class DefaultEWrapper implements EWrapper {
    ...
    @Override public void updatePortfolio(Contract contract, Decimal position, double marketPrice,
    ...
    @Override public void positionMulti(int reqId, String account, String modelCode, Contract contract,
                                         Decimal pos, double avgCost) {}
    @Override public void positionMultiEnd(int reqId) {}
    @Override public void accountUpdateMulti(int reqId, String account, String modelCode, String key,
                                              String value, String currency) {}
    @Override public void accountUpdateMultiEnd(int reqId) {}
    @Override public void securityDefinitionOptionalParameter(int reqId, String exchange,
    ...
    @Override public void smartComponents(int reqId, Map<Integer, java.util.Map.Entry<String, Character>> theMap) {}
    ...
    @Override public void historicalNews(int requestId, String time, String providerCode,
    ...
    @Override public void pnlSingle(int reqId, Decimal pos, double dailyPnL, double unrealizedPnL,
    ...
    @Override public void historicalTicksBidAsk(int reqId, java.util.List<HistoricalTickBidAsk> ticks,
                                                  boolean done) {}
    @Override public void historicalTicksLast(int reqId, java.util.List<HistoricalTickLast> ticks,
                                                boolean done) {}
    @Override public void tickByTickAllLast(int reqId, int tickType, long time, double price, Decimal size,
                                              TickAttribLast tickAttribLast, String exchange,
                                              String specialConditions) {}
    @Override public void tickByTickBidAsk(int reqId, long time, double bidPrice, double askPrice,
    ...
    @Override public void historicalSchedule(int reqId, String startDateTime, String endDateTime,
